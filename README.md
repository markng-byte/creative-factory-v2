...
🏗️ **[Design Package](docs/design/)** — the design for what comes next: [architecture](docs/design/target-architecture.md), [UX/UI spec](docs/design/ux-ui-spec.md), and [database design](docs/design/database-design.md).
